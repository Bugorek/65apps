        ...
        context.contentResolver?.query(
            ...
            ?.use { emailCursor ->
                if (emailCursor.moveToFirst()) {
                    emailCursor.getString(emailCursor.getColumnIndexOrThrow(ContactsContract.CommonDataKinds.Phone.NUMBER))
                        ?.let {
        ...
        context.contentResolver?.query(
            ...
            ?.use { noteCursor ->
                if (noteCursor.moveToNext()) {
                    noteCursor.getString(noteCursor.getColumnIndexOrThrow(ContactsContract.CommonDataKinds.Note.NOTE))
                        ?.let {
        ...
        context.contentResolver?.query(
            ...
            ?.use { contactCursor ->
                while (contactCursor.moveToNext()) {
                    val id =
                        contactCursor.getString(
                            contactCursor.getColumnIndexOrThrow(ContactsContract.CommonDataKinds.Phone.CONTACT_ID)
                        )
                    val name =
                        contactCursor.getString(
                            contactCursor.getColumnIndexOrThrow(ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME)
                        )
                    val contactNumber =
                        contactCursor.getString(
                            contactCursor.getColumnIndexOrThrow(ContactsContract.CommonDataKinds.Phone.NUMBER)
                        )
